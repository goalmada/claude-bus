...
| Orchestrator should self-pace and check for things to do | Set `CLAUDE_BUS_HEARTBEAT_MINUTES=N` on the session. Hook fires "🫀 anything worth doing?" prompt every N minutes; model decides act-or-no-op. Off by default. v0.12. |
